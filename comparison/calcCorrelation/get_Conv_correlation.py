...
B = torch.load("../predictions/Conv_predictions").transpose(2,3).reshape(-1, 2002, 8000).transpose(1,2) #shape 2500x2002x4x2000 -> 2500x8000x2002
...
torch.save(correlation_list, "Conv_correlation")
